...
| RSNA Knee MRI | **Blocked; left unverified** | The [RSNA page](https://www.rsna.org/artificial-intelligence/ai-image-challenge/knee-mri-ai-challenge) only says the challenge *will* launch in spring and conclude in October; it does not confirm that entry is currently open or link an active competition. |
